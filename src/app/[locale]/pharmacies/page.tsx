        ...
        <section className="px-6 lg:px-14 py-12 lg:py-16">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 lg:gap-14">
            ...
            <aside className="flex flex-col gap-5">
              ...
              <Link
                href="/catalogue"
                className="inline-flex items-center justify-center px-6 py-3.5 rounded-sm bg-clay-700 text-sand-50 text-[12.5px] font-semibold uppercase tracking-wider hover:bg-clay-800 transition-colors"
              >
                {t('ctaCatalogue')}
              </Link>
            </aside>

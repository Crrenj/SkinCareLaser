...
async function EmptyState() {
  ...
  return (
    <div className="bg-white border border-sand-300 rounded-md py-16 px-6 text-center">
      ...
      <Link
        href="/catalogue"
        className="inline-flex items-center gap-2.5 px-6 py-3 rounded-sm bg-clay-700 text-sand-50 text-[12.5px] font-semibold uppercase tracking-wider hover:bg-clay-800 transition-colors"
      >
        {t('emptyCta')}
      </Link>
    </div>

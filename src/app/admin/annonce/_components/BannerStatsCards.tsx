  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {SLOTS.map((slot) => {
        ...
        return (
          <article key={slot} className="rounded-xl bg-sand-50 border border-sand-200 p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-serif text-lg text-ink-900">{SLOT_LABELS[slot]}</h3>
              <span
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              <div>
                ...
                <p className="text-[10px] text-ink-500 font-mono uppercase">{t('views')}</p>
              </div>
              <div>
                ...
                <p className="text-[10px] text-ink-500 font-mono uppercase">{t('clicks')}</p>
              </div>
              <div>

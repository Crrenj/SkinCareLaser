...
export const sections: TutoSection[] = [
  {
    ...
    actions: [
      ...
      },
      {
        ...
        effects: [
          ...
          "“Activate product” box (checked by default): makes the product visible and reservable on the public site. Once online, no button can hide it again.",
        ],
        severity: "caution",
        audited: true,
    ...
    gotchas: [
      ...
      "In the initialization drawer, the “Activate product” box is CHECKED by default: untick it if the product is not ready to be sold, because once online, no button can hide it again.",

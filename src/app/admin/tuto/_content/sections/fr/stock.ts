...
export const sections: TutoSection[] = [
  {
    ...
    actions: [
      ...
      },
      {
        ...
        effects: [
          ...
          "Case « Activer le produit » (cochée par défaut) : rend le produit visible et réservable sur le site public. L'icône œil de l'écran Produits permet ensuite de le re-cacher (et republier) à tout moment.",
        ],
        severity: "caution",
        audited: true,
    ...
    gotchas: [
      ...
      "Dans le tiroir d'initialisation, la case « Activer le produit » est COCHÉE par défaut : décochez-la si le produit n'est pas prêt. Vous pourrez le publier (ou le re-cacher) plus tard avec l'icône œil de l'écran Produits.",

...
export const sections: TutoSection[] = [
  {
    ...
    actions: [
      ...
      },
      {
        ...
        effects: [
          ...
          "Casilla « Activar producto » (marcada por defecto): hace el producto visible y reservable en el sitio público. Una vez en línea, ningún botón permite volver a ocultarlo.",
        ],
        severity: "caution",
        audited: true,
    ...
    gotchas: [
      ...
      "En el panel de inicialización, la casilla « Activar producto » viene MARCADA por defecto: desmárquela si el producto no está listo para venderse, porque una vez en línea, ningún botón permite volver a ocultarlo.",

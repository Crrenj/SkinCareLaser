            ...
            <div className="mt-9 pt-6 border-t border-sand-300 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex gap-2.5 shrink-0">
                ...
                <button
                  ...
                  onClick={handleSave}
                  disabled={!isDirty || saving}
                  className="px-4 py-2.5 text-[13px] font-medium bg-clay-700 text-sand-50 rounded-lg hover:bg-clay-800 disabled:opacity-40 inline-flex items-center gap-2 transition-colors"
                >

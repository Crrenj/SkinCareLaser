          ...
          <div className="sticky bottom-4 mt-6 bg-ink-900 text-sand-50 rounded-xl shadow-lg px-5 py-3.5 flex items-center justify-between gap-4">
            ...
            <div className="flex gap-2 shrink-0">
              ...
              <button
                type="submit"
                disabled={saving}
                className="px-4 py-2 text-[13px] font-medium bg-clay-700 hover:bg-accent-hover text-on-accent rounded-lg disabled:opacity-50 inline-flex items-center gap-2 transition-colors"
              >

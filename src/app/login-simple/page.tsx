...
/**
 * ⚠️ ATTENTION - PAGE DE LOGIN SIMPLIFIÉE ⚠️
 * 
 * Version simplifiée pour diagnostic et tests.
 * 
 ...
 * - Backup si la page principale ne fonctionne pas
 * 
 * Fonctionnalités :
 * - Connexion directe sans complexité
 * - Logs détaillés pour debugging
 * - Gestion d'erreurs simplifiée
 * - Redirection basique admin/user
 */
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 py-4 bg-gray-50 text-center text-sm">
            ...
            <div className="space-y-2 mt-2">
              <a 
                href="/login" 
                className="block text-[#CCC5BD] hover:text-[#B8B1A8] underline"
              >

    ...
    >
      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className="inline-flex items-center px-4 py-2.5 rounded-sm bg-clay-700 hover:bg-accent-hover text-on-accent text-[12px] font-semibold uppercase tracking-wider transition-colors"
        >
          {t('acceptLabel')}
        </button>
        <button

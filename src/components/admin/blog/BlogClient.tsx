  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={openCreate}
          className="rounded-lg bg-clay-700 px-5 py-2.5 text-sm font-medium text-on-accent hover:bg-accent-hover transition-colors"
        >
          {t('newPost')}
        </button>
      </div>
          ...
          >
            ...
            <div className="sticky bottom-0 flex items-center justify-end gap-3 border-t border-sand-200 bg-sand-50 px-6 py-4">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="rounded-lg bg-clay-700 px-5 py-2 text-sm font-medium text-on-accent hover:bg-accent-hover transition-colors disabled:opacity-50"
              >

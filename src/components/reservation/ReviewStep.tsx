    ...
    <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-8">
      ...
      <div className="lg:hidden flex flex-col gap-3">
        <button
          type="submit"
          disabled={submitting}
          className="h-14 rounded-xl bg-clay-700 hover:bg-clay-800 text-sand-50 font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex flex-col items-center justify-center leading-tight gap-0.5"
        >
          {submitting ? (

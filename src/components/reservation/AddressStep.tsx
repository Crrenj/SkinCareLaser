  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <div className="flex flex-col-reverse sm:flex-row sm:justify-between sm:items-center gap-3">
        ...
        <button
          type="submit"
          className="h-12 px-7 rounded-lg bg-clay-700 text-on-accent font-medium text-[14.5px] hover:bg-accent-hover transition-colors inline-flex items-center justify-center gap-2 w-full sm:w-auto"
        >
          {t('continue')}
    ...
    <label className={`flex flex-col gap-1.5 ${fullWidth ? 'lg:col-span-2' : ''}`}>
      ...
      <input
        ...
        className="h-11 px-3 rounded-lg border border-sand-300 bg-sand-50 text-[14.5px] text-ink-900
                   placeholder:text-ink-500 focus-visible:outline-none focus-visible:border-clay-700

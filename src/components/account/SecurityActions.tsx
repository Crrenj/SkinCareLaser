  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        className="inline-flex items-center gap-2.5 px-5 py-3 rounded-sm bg-clay-700 hover:bg-clay-800 text-sand-50 text-[12.5px] font-semibold uppercase tracking-wider transition-colors disabled:opacity-60 disabled:cursor-not-allowed self-start"
      >

      ...
      <section className="bg-sand-100 border border-sand-300 rounded-md p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:items-end">
          ...
          <button
            ...
            className="inline-flex items-center justify-center px-5 h-11 rounded-sm bg-clay-700 hover:bg-accent-hover text-on-accent text-[12.5px] font-semibold uppercase tracking-wider transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >

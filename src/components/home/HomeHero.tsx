        ...
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-[clamp(32px,5vw,72px)] items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3.5">
              <Link
                href="/catalogue"
                className="group inline-flex items-center gap-2.5 px-5 py-3 rounded-[2px] bg-clay-700 text-on-accent text-[12.5px] font-semibold uppercase tracking-[0.06em] hover:bg-accent-hover transition-colors"
              >
                {t('primaryCta')}
